      ...
      <span>
        ...
        <div id="editModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 hidden">
          ...
          <div class="theme-modal-bg rounded-lg shadow-lg max-w-md w-full relative">
            ...
            <div class="mt-6 flex justify-center gap-3 bg-theme-surface p-2 rounded-b-lg">
              <button data-close class="theme-btn-outline">Cancel</button>
              <button id="confirmSave" data-route="/project-info/shutdown-isolation" data-close class="theme-btn">Save</button>
            </div>
          </div>
        </div>
      </span>
...
class AddWorkPack extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
        <div class="grid grid-cols-4 gap-4 items-center mt-6">
            <!-- Input fields -->
    ...
    ${[
        ...
        .join("")}
            ${["Authorisation", "Applies to Site Location"]
        .map(
          (label) => `
                    <label class="flex items-center gap-2">
                    <input type="radio" class="w-4 h-4" /> ${label}
...
customElements.define("add-workpack", AddWorkPack);
      ...
      <span>
        ...
        <div id="editModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 hidden">
          ...
          <div class="theme-modal-bg rounded-lg shadow-lg max-w-md w-full relative">
            ...
            <div class="mt-6 flex justify-center gap-3 bg-theme-surface p-2 rounded-b-lg">
              <button data-close class="theme-btn-outline">Cancel</button>
              <button id="confirmSave" data-route="/project-info/workpack-ctradmin" data-close class="theme-btn">Save</button>
            </div>
          </div>
        </div>
      </span>
